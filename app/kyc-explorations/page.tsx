...
const t = {
  es: {
    ...
    bannerB: 'Verifica tu identidad para desbloquear límites más altos y transferencias más rápidas.',
  ...
  en: {
    ...
    bannerB: 'Verify your identity to unlock higher limits and faster transfers.',
