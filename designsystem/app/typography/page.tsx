...
const fontWeights = [
  { name: "Display Black", weight: "800", sample: "Display Black", className: "font-display font-extrabold" },
  { name: "Display Bold", weight: "700", sample: "Display Bold", className: "font-display font-bold" },
  { name: "Sans Semibold", weight: "600", sample: "Sans Semibold", className: "font-sans font-semibold" },
  { name: "Sans Medium", weight: "500", sample: "Sans Medium", className: "font-sans font-medium" },
  { name: "Sans Regular", weight: "400", sample: "Sans Regular", className: "font-sans font-normal" },
  { name: "Sans Light", weight: "300", sample: "Sans Light", className: "font-sans font-light" },
]
      ...
      >
        <div className="grid gap-8 md:grid-cols-2">
          <div className="rounded-xl border border-border bg-card p-6">
            ...
            <p className="font-display text-4xl font-extrabold text-foreground">Plus Jakarta Sans</p>
            ...
            <div className="mt-6 flex flex-wrap gap-2">
              <span className="rounded-full bg-turquoise px-3 py-1 text-xs font-medium text-slate">Bold 700</span>
          ...
          <div className="rounded-xl border border-border bg-card p-6">
            ...
            <p className="font-sans text-4xl font-medium text-foreground">DM Sans</p>
            <p className="mt-4 text-sm text-muted-foreground">
            ...
            <div className="mt-6 flex flex-wrap gap-2">
              ...
              <span className="rounded-full bg-stone px-3 py-1 text-xs font-medium text-slate">Bold 700</span>
            </div>
          </div>
        </div>
      </Section>
      ...
      >
        <div className="rounded-xl bg-linen p-8 md:p-12">
          <div className="grid gap-8 md:grid-cols-[200px_1fr]">
            <div>
              <p className="text-sm font-bold text-foreground">Display Black</p>
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-[200px_1fr]">
            <div>
              <p className="text-sm font-bold text-foreground">Sans Light</p>
