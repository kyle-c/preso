...
(() => {
  // options/options.ts
  var anthropicKeyInput = document.getElementById("anthropic-key");
  var anthropicModelSelect = document.getElementById("anthropic-model");
  var anthropicModelInfo = document.getElementById("anthropic-model-info");
  var openrouterKeyInput = document.getElementById("openrouter-key");
  var openrouterModelSelect = document.getElementById("openrouter-model");
  var openrouterModelInfo = document.getElementById("openrouter-model-info");
  var openrouterCustomInput = document.getElementById("openrouter-custom");
  ...
  function renderModelInfo(el, meta) {
    if (!meta) {
